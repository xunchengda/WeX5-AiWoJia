...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"> 
    <div class="x-panel-content tb-trans"> 
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
                    ...
                    <div component="$UI/system/components/bootstrap/carousel/carousel" class="x-carousel carousel" xid="carousel1" auto="true" interval="4"> 
                      ...
                      <div class="x-contents carousel-inner" role="listbox" component="$UI/system/components/justep/contents/contents" active="0" slidable="true" wrap="true" swipe="true" xid="contentsImg" routable="false"> 
                        <div class="x-contents-content" xid="content2"> 
                          <img src="./main/img/slide-1.jpg" alt="" xid="image13" bind-click="openPageClick" class="tb-img1" pagename="./detail.w" align="middle" /> 
                        </div> 
                      </div> 
                    </div> 
                  </div>  
                        ...
                        <tr xid="tr1"> 
                          <td bind-click="openPageClick" pagename="./list.w" xid="td1"> 
                            <div class="text-center" xid="div2"> 
                              <img src="$UI/mine/aiwojia/main/img/icon-menu-1.png" alt="" xid="image3" class="img-responsive center-block tb-img5" />  
                              <span xid="span7"><![CDATA[待办业务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td2"> 
                            <div class="text-center" xid="div3"> 
                              <img src="./main/img/icon-menu-2.png" alt="" xid="image1" class="img-responsive center-block tb-img5" />  
                              <span xid="span9"><![CDATA[生活服务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td3"> 
                            <div class="text-center" xid="div4"> 
                              <img src="./main/img/icon-menu-3.png" alt="" xid="image2" class="img-responsive center-block tb-img5" />  
                        ...
                        <tr xid="tr2">
                          <td bind-click="openPageClick" pagename="./list.w" xid="td4"> 
                            <div class="text-center" xid="div7"> 
                              <img alt="" xid="image8" src="./main/img/icon-menu-4.png" class="img-responsive center-block tb-img5" />  
                              <span xid="span11"><![CDATA[休闲服务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td5"> 
                            <div class="text-center" xid="div8"> 
                              <img alt="" xid="image9" src="./main/img/icon-menu-5.png" class="img-responsive center-block tb-img5" />  
                              <span xid="span12"><![CDATA[出行服务]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td6"> 
                            <div class="text-center" xid="div2"> 
                              <img alt="" xid="image3" src="./main/img/icon-menu-6.png" class="img-responsive center-block tb-img5" />  
                              <span xid="span19"><![CDATA[商务服务]]></span> 
                            </div> 
                          </td>  
                        </tr>  
                        <tr xid="tr3">
                          <td bind-click="openPageClick" pagename="./list.w" xid="td7"> 
                            <div class="text-center" xid="div3"> 
                              <img alt="" xid="image1" src="./main/img/icon-menu-7.png" class="img-responsive center-block tb-img5" />  
                              <span xid="span20"><![CDATA[最新消息]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td8"> 
                            <div class="text-center" xid="div4"> 
                              <img alt="" xid="image2" src="./main/img/icon-menu-8.png" class="img-responsive center-block tb-img5" />  
                              <span xid="span10"><![CDATA[个人中心]]></span> 
                            </div> 
                          </td>  
                          <td bind-click="openPageClick" pagename="./list.w" xid="td9"> 
                            <div class="text-center" xid="div7"> 
                              <img alt="" xid="image8" src="./main/img/icon-menu-9.png" class="img-responsive center-block tb-img5" />  
        ...
        </div><div class="x-contents-content x-cards" xid="userContent"> 
          <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" xid="back" icon="fa fa-angle-left fa-fw" target="homeContent" style="padding: 5px;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2" style="background-color:white; margin-top:10px; padding:0;">
   <div class="x-col" xid="col8" style="padding: 0;">
   <ul xid="ul1" class="list-group" style="margin:0;">
	   <li xid="" class="list-group-item">
		  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right" label="button" xid="" icon="icon-ios7-arrow-right">
		   <i xid="" class="icon-ios7-arrow-right"></i>
		   <span xid=""></span></a><i class="fa fa-map-marker fa-fw"></i><span xid="span13"><![CDATA[我的收货地址]]></span>
	   </li>
	   <li xid="" class="list-group-item">
		  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right" label="button" xid="" icon="icon-ios7-arrow-right">
		   <i xid="" class="icon-ios7-arrow-right"></i>
		   <span xid=""></span></a><i class="fa fa-credit-card fa-fw"></i><span xid="span14"><![CDATA[我的卡券]]></span>
	   </li>
   ...
   <i class="fa fa-user fa-fw" xid="i11"></i>
   <span xid="span15"><![CDATA[我的会员]]></span></li></ul>
  </div>
   </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="background-color:white; margin-top:10px; padding:0;">
   <div class="x-col" xid="col4" style="padding: 0;">
    <ul xid="ul2" class="list-group" style="margin:0;">
     <li xid="li2" class="list-group-item">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right" label="button" xid="button6" icon="icon-ios7-arrow-right">
       <i xid="i13" class="icon-ios7-arrow-right"></i>
       <span xid="span24"></span></a> 
      <i class="fa fa-lock fa-fw" xid="i14"></i>
      <span xid="span21"><![CDATA[账户与安全]]></span></li> 
     <li xid="li4" class="list-group-item">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right" label="button" xid="button7" icon="icon-ios7-arrow-right">
       <i xid="i15" class="icon-ios7-arrow-right"></i>
       <span xid="span25"></span></a> 
      <i class="fa fa-comments fa-fw" xid="i16"></i>
      <span xid="span18"><![CDATA[爱我家客服]]></span></li> 
     <li xid="li1" class="list-group-item">
      ...
      <i class="fa fa-users fa-fw" xid="i7"></i>
      <span xid="span23"><![CDATA[关于爱我家]]></span></li> </ul> </div> </div>
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4" style="background-color:white; margin-top:10px; padding:0;">
    ...
    <ul xid="ul3" class="list-group" style="margin:0;">
     <li xid="li5" class="list-group-item fa-cog">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right" label="button" xid="button10" icon="icon-ios7-arrow-right">
       <i xid="i17" class="icon-ios7-arrow-right"></i>
       <span xid="span28"></span></a> 
      <i class="fa fa-cog fa-fw" xid="i20"></i>
      <span xid="span29"><![CDATA[设置]]></span></li> 
